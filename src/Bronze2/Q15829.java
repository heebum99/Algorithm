...
public class Q15829 {
    public static void main(String[] args) throws IOException {
        ...
        BigInteger hashValue = BigInteger.valueOf(0); //계산된 해시값, BigInteger 사용
        ...
        for (int i = 0; i < L; i++) {
            ...
            //거듭제곱을 사용하기 위해 Math 클래스의 pow()메서드 or BigInteger의 pow()메서드 사용
            hashValue = hashValue.add(BigInteger.valueOf(value).multiply(BigInteger.valueOf(r).pow(i)));
        }

        bw.write(String.valueOf(hashValue.remainder(BigInteger.valueOf(M))));
        bw.flush();
